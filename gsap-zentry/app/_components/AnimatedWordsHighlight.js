...
export function WordHighlightParagraphs({
  ...
  className = "",
  sectionClassName = "",
  backgroundColor = "rgba(191, 188, 180, 0.92)",
}) {
  ...
  return (
    <>
      ...
      <section
        ref={sectionRef}
        className={`anime-text-container min-h-screen bg-[#f4eee6] ${sectionClassName}`}
      >
        <div className="flex min-h-screen items-center justify-center px-6">
          <div
            className={`max-w-5xl space-y-12 text-left text-3xl font-bold leading-[1.35] tracking-tight md:text-5xl ${className}`}
          >
                ...
                {paragraph.map((word, index) => {
                  ...
                  return (
                    <span
                      ...
                      className={`word mr-2 inline-block rounded-md px-1.5 py-0.5 md:mr-3 ${
                        isKeyword
...
export default function GSAPWordHighlightPreview() {
  return (
    <main className="min-h-screen bg-[#f4eee6] text-[#282828]">
